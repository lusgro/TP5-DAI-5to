...
VALUES ('Location A', 1, -34.6037, -58.3816),
       ('Location B', 2, -32.9541, -60.6783);
...
-- Insertar eventos
INSERT INTO events (name, description, id_event_category, id_event_location, start_date, duration_in_minutes, price, enabled_for_enrollment, max_assitance, id_creator_user)
